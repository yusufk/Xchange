...
db.define_table('user_location',
                ...
                Field('latitude'),
                Field('longitude'),
                Field('eventtime','datetime',requires=IS_DATETIME(format='%d/%m/%Y %H:%M:%S'),default=request.now))

db.define_table('authorised',
                Field('user_id','reference auth_user',),
                Field('authorised_user','reference auth_user',),
                Field('eventtime','datetime',requires=IS_DATETIME(format='%d/%m/%Y %H:%M:%S'),default=request.now))
